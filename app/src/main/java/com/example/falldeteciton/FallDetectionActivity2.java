...
public class FallDetectionActivity2 extends AppCompatActivity implements SensorEventListener {

    private SensorManager mySensorManager;
    private Sensor myAccelerometer;
    private Sensor myGyroscope;

    private final static String TAG = FallDetectionActivity2.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstance){
        ...
        mySensorManager.registerListener(FallDetectionActivity2.this, myAccelerometer, mySensorManager.SENSOR_DELAY_UI);
        Log.d(TAG, "onCreate: Accelerometer listener is registered.");
        mySensorManager.registerListener(FallDetectionActivity2.this, myGyroscope, mySensorManager.SENSOR_DELAY_NORMAL);
...
//        fd.show(getSupportFragmentManager(), "alert dialog");
    ...
    protected void onDestroy() {
        mySensorManager.unregisterListener(FallDetectionActivity2.this);
        thread.interrupt();
        super.onDestroy();
    }
